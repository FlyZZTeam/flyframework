 ...
 */
class DBMysqliDriver extends DBComponent
{
     ...
     * @return resource
     */
    protected function  _setCharset($charset, $collation)
    {
        ...
        if ($this->use_set_names === true) {
            return @mysqli_query($this->conn_id, "SET NAMES '".$this->escapeString($charset)."' COLLATE '".$this->escapeString($collation)."'");
        } else {

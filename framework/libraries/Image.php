    ...
    public function overlayWatermark()
    {
        ...
        switch ($this->wmVrtAlignment) {
            case 'T':
                break;
            case 'M':
                $y_axis += ($this->origHeight / 2) - ($wm_height / 2);
                break;
            case 'B':
                $y_axis += $this->origHeight - $wm_height;
                break;
        }
        ...
        switch ($this->wmHorAlignment) {
            case 'L':
                break;
            case 'C':
                $x_axis += ($this->origWidth / 2) - ($wm_width / 2);
                break;
            case 'R':
                $x_axis += $this->origWidth - $wm_width;
                break;
        }
    ...
    public function textWatermark()
    {
        ...
        switch ($this->wmVrtAlignment) {
            case     "T" :
                break;
            case "M":
                $y_axis += ($this->origHeight / 2) + ($fontheight / 2);
                break;
            case "B":
                $y_axis += ($this->origHeight - $fontheight - $this->wmShadowDistance - ($fontheight / 2));
                break;
        }

...
class Security
{
    ...
    /**
     * @var array List of never allowed regex replacement
     */
    ...
    public function __construct()
    {
        ...
        Fly::log('debug', "Security Class Initialized");
    }
    ...
    public function csrfVerify()
    {
        ...
        Fly::log('debug', 'CSRF token verified');
    ...
    {
        throw new FlyException(Fly::t('fly', 'The action you have requested is not allowed.'));
    }
    ...
    public function cleanXss($str, $is_image = false)
    {
        ...
        Fly::log('debug', "XSS Filtering completed");
        return $str;
    }
    ...
    {
        return $this->entityDecode($match[0], strtoupper(Fly::app()->charset));
    }
     ...
     * Do Never Allowed
     *
     * A utility function for cleanXss()
     *
     * @param string
     * @return string
     */

...
class HttpSession extends ApplicationComponent implements IteratorAggregate,ArrayAccess,Countable
{
    ...
    public function open()
    {
        ...
        if (FLY_DEBUG && session_id()=='') {
            ...
            Fly::log('debug', $message, 'system.libraries.HttpSession');
        }
    }
     ...
     * @throws FlyException if the value is beyond [0,100]
     */
    ...
    //------ The following methods enable HttpSession to be Map-like -----
